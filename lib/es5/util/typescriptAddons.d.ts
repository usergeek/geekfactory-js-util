...
export declare function hasOwnProperty<X extends {}, Y extends KeysOfUnion<X>>(obj: X, prop: Y): obj is X & Record<Y, unknown>;
type Keys<T> = keyof T;
...
export type DistributiveOmit<T, K extends DistributiveKeys<T>> = T extends unknown ? keyof Omit_<T, K> extends never ? never : {
